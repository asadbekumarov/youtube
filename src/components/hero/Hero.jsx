...
export default function Hero() {
  ...
  return (
    <>
      <section className="pt-4 pb-6 pl-6 pr-6 bg-[#212121] flex">
        <aside className="w-[240px]">
          <div>
            <div className="flex text-white w-[240px] gap-6 pb-5">
        ...
        <div className="flex flex-wrap items-center text-center">
          {datas.map((data) => (
            <div
              key={data.id}
              className="items-center gap-4 p-4 bg-[#212121] rounded-md"
            >
              <img
                className="w-[302px] h-[250px] object-cover"
                src={data.image}
                alt={data.description}
              />
              <div className="flex text-start items-start mt-3 gap-3">
                <img
                ...
                />
                <div>
                  <p className="text-base  mb-2 font-normal text-[#FFFFFF] max-w-[270px] text-start">
                    {data.title}
                  </p>

                  <h3 className="text-sm font-normal text-[#a3a3a3] text-start">
                    {data.category}
                  </h3>
                  <div className="flex gap-2">
                    <p className="text-sm font-normal text-[#a3a3a3] text-start">
                      {data.price} Görüntüleme
                    </p>
                    <p className="text-sm font-normal text-[#a3a3a3] text-start">
                      {data.price} Dakika önce
                    </p>
                  </div>
                </div>
              </div>
